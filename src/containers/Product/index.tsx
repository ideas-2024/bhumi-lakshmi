    ...
    return (
        <div className="">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="">
                    <img src="./../../assets//Crop Solutions.png" className="width:20px rounded-lg" />
                </div>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="flex justify-center py-12">
                    <img src="./../../assets//Plant Growth Regulators.jpg" className="width:20px rounded-lg" />
                </div>
            ...
            <div className="space-y-4 py-12">
                ...
                <div className="flex justify-center py-12">
                    <img src="./../../assets//Pesticide.jpg" className="width:20px rounded-lg" />
                </div>
